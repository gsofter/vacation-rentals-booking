...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>@isset($roomdetail) {{$roomdetail}} @endisset</title> 
        <meta name="description" content="{{ substr(strip_tags($rooms_description), 0, 177) }}...">
        ...
        <meta property="og:title" content="@isset($roomdetail) {{$roomdetail}} @endisset">
        <meta property="og:description" content="{{ substr(strip_tags($rooms_description), 0, 177) }}...">
        <meta property="og:site_name" content="https://www.vacation.rentals">
        <meta property="og:image" content="{{ isset($featured_image) ? $featured_image :  ''}}">
        <meta property="og:locale" content="en_US">
        <meta property="og:profile:username" content="VacationRentals4U">
        <meta name="twitter:card" content="summary">
        <meta name="twitter:site" content="@Vacarent">
        <meta name="twitter:title" content="@isset($roomdetail) {{$roomdetail}} @endisset">
        <meta name="twitter:description" content="{{ substr(strip_tags($rooms_description), 0, 177) }}...">
        <meta name="twitter:creator" content="@Vacarent">
        <meta name="twitter:url" content="https://www.vacation.rentals">
        <meta name="twitter:image" content="{{ isset($featured_image) ? $featured_image :  ''}}">
        ...
        <link rel="stylesheet" href="https://res.cloudinary.com/vacation-rentals/raw/upload/v1554823151/css/listingdetail/app.css" type="text/css">
    </head>
    <body class="home_view v2 simple-header p1  new_home ng-scope">
        ...
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1555513868/js/listingdetail/app.js"></script>
