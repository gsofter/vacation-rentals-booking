            ...
            <div class="page-header">
               ...
               <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                     ...
                     <li class="breadcrumb-item"><a href="{{route('admin.pages')}}">Static Pages</a></li>
               ...
               <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-block">
                        <form method="POST" action="{{url('admin/add_page')}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered row" role="form">
                            {{ csrf_field() }}
                        <div class="col-sm-7">                                
                                    ...
                                    <div class="tab-content card-block">
                                        <div class="tab-pane active" id="general" role="tabpanel" >
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="file" name="image" id="input-file-now1" data-default-file="{{asset("images/pages/default.jpg")}}" class="dropify"  />                                    
                                                </div>
                                            </div>
