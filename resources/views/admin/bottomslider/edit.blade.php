                    ...
                    <div class="card-block">
                        <form method="POST" action="{{url('admin/edit_bottom_slider/'.$bottomslider->id)}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="title" class="form-control"  value="{{$bottomslider->title}}" placeholder="Title" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label text-right">Description<span class="text-danger">*</span></label>
                                <div class="col-sm-6">
                                    <textarea type="text" name="description" class="form-control"  required>{{$bottomslider->description}}</textarea>
                                </div>
                            </div>     
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="file" name="image" id="input-file-now1" data-default-file="{{asset("images/bottom_slider/$bottomslider->image")}}" class="dropify"  />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="order" value="{{$bottomslider->order}}" class="form-control" value="0" placeholder="order" required>
                                </div>
                            </div>
