               ...
               <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    @if(count($data) != 0)
                        ...
                        <tr>
                            <td>{{$row->id}}</td>                            
                            <td><img src="{{asset("images/bottom_slider/$row->image")}}" style="height:100px"></td>
                            <td>{{$row->title}}</td>
                            <td>{{$row->description}}</td>
                            <td>{{$row->status}}</td>                            
                            <td class="text-center">
                                <a href="{{url( 'admin/edit_bottom_slider/' . $row->id )}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="" data-original-title="Edit">
