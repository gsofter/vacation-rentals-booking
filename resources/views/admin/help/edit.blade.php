               ...
               <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-block">
                        <form method="POST" action="{{url('admin/edit_help/'.$help->id)}}"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                            {{ csrf_field() }}
                                ...
                                <div class="col-sm-6">
                                    <select name="category_id" id="category" class="form-control form-control-default required select2" required> 
                                        @foreach($categories as $cat)            
                                            <option value="{{$cat->id}}" <?php echo $help->category_id==$cat->id?"selected":""; ?>>{{$cat->name}}</option> 
                                        @endforeach
                                    </select>
                                </div>
                            </div> 
                                ...
                                <div class="col-sm-6">
                                    <select name="subcategory_id" id="subcategory" class="form-control form-control-default required select2" required> 
                                        @foreach($subcategories as $subcat)            
                                            <option value="{{$subcat->id}}" <?php echo $help->category_id==$subcat->id?"selected":""; ?>>{{$subcat->name}}</option> 
                                        @endforeach
                                    </select>
                                </div>
                            </div> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="question" class="form-control" value="{{$help->question}}" placeholder="Question" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">                                       
                                    <textarea name="answer" class="summernote">{{$help->answer}}</textarea>
                                </div>             
                            </div>   
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="status" class="form-control form-control-default required select2" required>   
                                        <option value="Active" <?php echo $help->status=="Active"?"selected":""; ?>>Active</option>                                            
                                        <option value="Inactive" <?php echo $help->status=="Inactive"?"selected":""; ?>>Inactive</option> 
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 form-radio">
                                    <div class="radio radio-inline">
                                        <label>
                                        <input type="radio" name="suggested" <?php echo $help->suggested=="yes"?"checked":""; ?> value="yes">
                                        <i class="helper"></i>Yes
                                        </label>
                                    </div>
                                    <div class="radio radio-inline">
                                        <label>
                                        <input type="radio" name="suggested" <?php echo $help->suggested=="no"?"checked":""; ?> value="no">
                                        <i class="helper"></i>No
                                        </label>
                                    </div>                               
                                </div>                               
