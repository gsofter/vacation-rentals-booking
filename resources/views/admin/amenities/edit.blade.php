                    ...
                    <div class="card-block">
                        <form method="POST" action="{{url('admin/edit_amenity/'.$amenity->id)}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="name" class="form-control" value="{{$amenity->name}}" placeholder="name" required>
                                </div>
                            </div>                                          
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="file" name="image" id="input-file-now1" data-default-file="{{asset("images/amenities/$amenity->icon")}}" class="dropify"  />
