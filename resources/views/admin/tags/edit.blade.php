               ...
               <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-block">
                        <form method="POST" action="{{url('admin/add_tag')}}"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="name" class="form-control" value="{{$tag->name}}" placeholder="name" required>
                                </div>
                            </div>                                          
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 text-center">
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <a href="{{route('admin.tags')}}" class="btn btn-default btn-round">Cancel</a>
                                </div>
                            </div>
                        </form>
