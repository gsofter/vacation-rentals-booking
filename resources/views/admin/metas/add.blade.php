                    ...
                    <div class="card-block">
                        <form method="POST" action="{{url('admin/add_meta')}}"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="meta_h1" class="form-control"  placeholder="H1 Tag" required>
                                </div>
                            </div>   
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label text-right">Meta Description<span class="text-danger">*</span></label>
                                <div class="col-sm-6">
                                    <textarea type="text" name="description" class="form-control"  placeholder="Meta Description" required></textarea>
                                </div>
                            </div>   
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <textarea type="text" name="keywords" class="form-control"  placeholder="Keywords" required></textarea>
                                </div>
                            </div>                               
