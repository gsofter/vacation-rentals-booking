               ...
               <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-block">
                        <form method="POST" action="{{url('admin/edit_post/' . $post->id)}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered row" role="form">
                            {{ csrf_field() }}
                        ...
                        <div class="col-sm-7">                                
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="excerpt" class="form-control"  value={{$post->excerpt}} placeholder="Excerpt" required>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-5">  
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" name="image" id="input-file-now1" data-default-file="{{asset("images/posts/$post->image")}}" class="dropify"  />                                    
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <select name="author_id"  class="categories-select form-control required" required>
                                        ...
                                        @foreach($authores as $row)
                                            <option value="{{$row->id}}" <?php echo $row->id==$post->author_id?"selected":""; ?>>{{$row->first_name}} {{$row->last_name}}</option>
                                        @endforeach                                           
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <select name="categories[]"  class="categories-select form-control" multiple="multiple">
                                        ...
                                        @foreach($categories as $cat)
                                            ...
                                            @foreach($postCategories as $c)
                                                ...
                                                @endphp                                                
                                            @endforeach 
                                            <option value="{{$cat->id}}" <?php echo $flag==1?"selected":"";?>>{{$cat->name}}</option>                                          
                                        @endforeach                                           
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <select name="tags[]"  class="categories-select form-control" multiple="multiple">
                                        ...
                                        @foreach($tags as $tag)
                                            ...
                                            @endforeach
                                            <option value="{{$tag->id}}" <?php echo $flag==1?"selected":"";?>>{{$tag->name}}</option>                                           
                                        @endforeach                                           
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 checkbox-fade fade-in-default">
                                    <label>
                                        <input type="checkbox" name="featured" value="1" <?php echo $post->featured =="1"?"checked":"";?> class="form-control">
                                        <span class="cr">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input id="dropper-default"  name="publish_date" class="form-control required" type="text" value="{{date('Y-m-d', strtotime($post->publish_date))}}" required />
                                </div>
                            </div>
