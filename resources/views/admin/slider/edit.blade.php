               ...
               <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-block">
                        <form method="POST" action="{{url('admin/edit_slider/'.$slider->id)}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="file" name="image" id="input-file-now1" data-default-file="{{asset("images/slider/$slider->image")}}" class="dropify"  />
                                    <input type="hidden" value="{{$slider->image}}" name="orginalimage">
                                </div>
                            </div>                            
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="order" value="{{$slider->order}}" class="form-control" value="0" placeholder="order" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 text-center">
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <a href="{{route('admin.slider')}}" class="btn btn-default btn-round">Cancel</a>
                                </div>
                            </div>
                        </form>
