               ...
               <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-header table-card-header">  
                        <div class="row">
                            <div class="col-sm-9 text-left">
                                <h5>Add  Help Subcategory Form</h5>
                            </div>                          
                    ...
                    <div class="card-block">
                        <form method="POST" action="{{url('admin/add_help_subcategory')}}" enctype="multipart/form-data"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                                {{ csrf_field() }}
