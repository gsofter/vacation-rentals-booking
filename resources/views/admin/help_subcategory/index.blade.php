            ...
            <div class="page-header">
               ...
               <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                     ...
                     <li class="breadcrumb-item">Help Subcategory</li>
                  </ul>
               </div>
            </div>
            <div class="page-body">
               <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-header table-card-header text-right">                            
                        <a href="{{url('admin/add_help_subcategory')}}" class="btn btn-primary">Add Help Subcategory</a>
                    </div>
                    ...
                    @if(count($data) != 0)
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{url( 'admin/edit_help_subcategory/' . $row->id )}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="" data-original-title="Edit">
         ...
         <div class="modal fade" id="default-Modal" tabindex="-1" role="dialog" style="z-index: 1050; display: none;" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form method="POST" action="{{url('admin/delete_help_subcategory')}}" accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                        {{ csrf_field() }}
