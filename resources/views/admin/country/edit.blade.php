                    ...
                    <div class="card-block">
                        <form method="POST" action="{{url('admin/edit_country/'.$country->id)}}"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="short_name" value="{{$country->short_name}}" class="form-control"  placeholder="Short Name" required>
                                </div>
                            </div>                                          
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="long_name" value="{{$country->long_name}}"  class="form-control"  placeholder="Long Name" required>
                                </div>
                            </div>                                          
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="iso3" value="{{$country->iso3}}" class="form-control"  placeholder="Iso3" required>
                                </div>
                            </div>                                          
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="num_code" value="{{$country->num_code}}" class="form-control"  placeholder="Num Code" required>
                                </div>
                            </div>                                          
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="phone_code" value="{{$country->phone_code}}" class="form-control"  placeholder="Phone Code" required>
                                </div>
                            </div>                                          
