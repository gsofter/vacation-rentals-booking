               ...
               <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-block">
                        <form method="POST" action="{{url('admin/edit_template/'.$template->id)}}"  accept-charset="UTF-8" class="form-horizontal bordered" role="form">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="name" class="form-control" value="{{$template->name}}" placeholder="name" required>
                                </div>
                            </div>                                          
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="type" class="form-control" value="{{$template->type}}" placeholder="Type" required>
                                </div>
                            </div>                                          
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">                                
                                    <input type="text" name="action" class="form-control" value="{{$template->action}}" placeholder="Action" required>
                                </div>
                            </div>                                          
