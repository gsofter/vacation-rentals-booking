...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel="stylesheet" href="https://res.cloudinary.com/vacation-rentals/raw/upload/v1554221617/css/app.css" type="text/css">
    ...
    <body class="home_view v2 simple-header p1  new_home ng-scope">
        ...
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1554406603/js/inbox/manifest.js"></script>
        ...
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1554406605/js/inbox/vendor.js"></script>
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1554406604/js/inbox/inbox.js"></script>
        {{--  <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1553980992/js/menu.js"></script>  --}}
