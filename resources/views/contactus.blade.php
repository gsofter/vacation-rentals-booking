...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel="stylesheet" href="https://res.cloudinary.com/vacation-rentals/raw/upload/v1555166737/css/contactus/app.css" type="text/css">
    ...
    <body class="home_view v2 simple-header p1  new_home ng-scope">
        ...
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1555168785/js/contactus/manifest.js"></script>
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1555168787/js/contactus/vendor.js"></script>
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1555179134/js/contactus/app.js"></script>
