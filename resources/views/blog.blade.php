...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="home_view v2 simple-header p1  new_home ng-scope">
        ...
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1554568542/js/blog/manifest.js"></script>
        ...
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1554568569/js/blog/vendor.js"></script>
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1554568543/js/blog/Blog.js"></script>
