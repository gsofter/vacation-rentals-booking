...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>No Fee Vacation Rentals From Owners And Property Managers</title>
        <meta name="description" content="Vacation rentals from owners and property managers. Rent direct with no booking fees, no commissions, no hidden service charges. Incredible vacation homes for rent across the nation from verified owners. Great savings, easy communication.">
    ...
    <body class="home_view v2 simple-header p1  new_home ng-scope" keywords="vacation, rentals, vacation rentals, property manager, property owner, no fees, commissions, direct communication">
        ...
        @if(isset($index_page_data))
        <script id="page_json_data" type="application/json">{!! json_encode($index_page_data) !!}</script>
        @else
        <script id="page_json_data" type="application/json"></script>
        @endif
