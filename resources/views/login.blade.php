...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="home_view v2 simple-header p1  new_home ng-scope">
        ...
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1554407046/js/auth/manifest.js"></script>
        ...
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1554407048/js/auth/vendor.js"></script>
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1555608212/js/auth/app.js"></script>
