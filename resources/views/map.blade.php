...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel="stylesheet" href="https://res.cloudinary.com/vacation-rentals/raw/upload/v1555427328/css/app.css" type="text/css">
    ...
    <body class="home_view v2 simple-header p1  new_home ng-scope">
        ...
        // I am thinking this is issue or not.
        
        {{--  <script src="https://js.stripe.com/v3/"></script>  --}}
      
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1555428634/js/map/app.js"></script>
