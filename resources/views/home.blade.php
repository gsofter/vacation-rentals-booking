		...
		<div class="hero shift-with-hiw js-hero">
			<div class="hero__background" data-native-currency="ZAR" aria-hidden="true">
					...
					<ul class="rslides" id="home_slider">
                        ...
                        <li><img alt="" src="{{ asset('images/slider/slider_1538410411.jpeg') }}" width="100%"></li>
						...
						<div class="back-black">
							<div class="show-sm hide-md sm-search">
								<form id="simple-search" class="simple-search hide js-p1-simple-search">
									...
									<input type="text" placeholder="Where do you want to go?" autocomplete="off" name="locations" id="simple-search-location" class="input-large js-search-location">
								...
								<form action="{{ url('s') }}" class="simple-search clearfix" method="get" id="searchbar-form" name="simple-search">
									<div class="saved-search-wrapper searchbar__input-wrapper">
										<label class="input-placeholder-group searchbar__location">
											<span class="input-placeholder-label screen-reader-only">Where do you want to go?</span>
											<input class="menu-autocomplete-input text-truncate form-inline location input-large input-contrast" placeholder="Where do you want to go?" type="text" name="locations" id="location" aria-autocomplete="both" autocomplete="off" value="">
										</label>
										<div class="searchbar__location-error hide">Please set location</div>
										<label class="input-placeholder-group searchbar__checkin">
											<span class="input-placeholder-label screen-reader-only">Check In</span>
											<input type="text" readonly="readonly" onfocus="this.blur()" id="checkin" class="checkin text-truncate input-large input-contrast ui-datepicker-target" placeholder="Check IN">
											<input type="hidden" name="checkin">
										</label>
										<label class="input-placeholder-group searchbar__checkout">
											<span class="input-placeholder-label screen-reader-only">Check out</span>
											<input type="text" id="checkout" onfocus="this.blur()" readonly="readonly" class="checkout input-large text-truncate input-contrast ui-datepicker-target" placeholder="Check In">
											<input type="hidden" name="checkout">
										</label>
										<label class="searchbar__guests">
											<span class="screen-reader-only">1 Guest</span>
											<div class="select select-large">
												<select id="guests" name="guests">
													@for($i=1;$i<=30;$i++)
														<option value="{{ $i }}"> {{ ($i == '30') ? $i.'+ '.trans_choice('guest',$i) : $i.' '.trans_choice('guest',$i) }} </option>
													@endfor
												</select>
											</div>
										</label>
									...
									<button id="submit_location" type="submit" class="searchbar__submit btn btn-primary btn-large">Search</button>
								</form>
							</div>
						</div>
					</div>
					...
					<div class="row space-top-8 text-center">
						...
						<div class="how-it-works__step how-it-works__step-two col-md-4">
							<div class="panel-body">
								...
								<p>{{ trans('messages.home.book_stay_desc') }}</p>
							</div>
						</div>
