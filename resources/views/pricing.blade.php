...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel="stylesheet" href="https://res.cloudinary.com/vacation-rentals/raw/upload/v1554403249/css/managelisting/app.css" type="text/css">
    ...
    <body class="home_view v2 simple-header p1  new_home ng-scope">
        ...
        <script src="https://res.cloudinary.com/vacation-rentals/raw/upload/v1554672059/js/pricing/app.js"></script>
