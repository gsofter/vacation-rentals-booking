...
import ChatHistory from './chatcontainer/ChatHistory';
...
class ChatContainer extends React.PureComponent{
    ...
    render(){
        return  <div className="in-chat">
        <div className="chat-header">
          <div className="chat-user-del">
            <div className="respon-arrow" onClick={this.props.handleLeftSidebar}><i className="fas fa-chevron-left" /></div>
            ...
            <div className="chat-user-info">
              ...
              <small>{this.props.contactUser.email} & {this.props.contactUser.primary_phone_number}</small>
            </div>
          </div>
          ...
          <div className="chat-f-wrap">
          {
            ...
            <div className="chat-f-input">
              ...
              <label htmlFor={"file"+this.props.contactUser.id} className='chat_file_upload_label'>
                ...
                {/* <i className="far fa-image" /> */}
                <input onChange={this.fileChange} className='chat_file_upload' type='file' id={"file"+this.props.contactUser.id} style={{ display : 'none' }}/>
              </div>
