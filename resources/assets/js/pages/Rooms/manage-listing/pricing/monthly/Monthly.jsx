            ...
            <div className="base_priceamt">
                ...
                <div className="base_text">
                    <div className="col-md-6 base_amut bottom_space">
                        ...
                        <input type="number" onChange={this.props.onChange} value={this.props.week_value} data-extras="true" id="price-week"  name="week" className="autosubmit-text input-stem input-large" data-saving="additional-saving" />
                        </div>
                    ...
                    <div className="col-md-6 base_amut bottom_space">
                        ...
                        <div className="base_pric">
                        <div className="price_doller input-prefix">{this.props.code}</div>
                        <input type="number" onChange={this.props.onChange} value={this.props.month_value} data-extras="true"  id="price-month" name="month" className="autosubmit-text input-stem input-large" data-saving="additional-saving" />
                        </div>
