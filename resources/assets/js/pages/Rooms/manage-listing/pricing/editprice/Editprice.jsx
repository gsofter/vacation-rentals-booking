                            ...
                            <table id="pricing_price_table" className="table dataTable no-footer dtr-inline" style={{width: '100%'}} role="grid">
                                ...
                                <tbody>
                                    <tr role="row" className="odd">
                                        ...
                                        <td>
                                        {this.props.code} {this.props.data.original_night ? this.props.data.original_night : '-'}
                                        </td>
                                        <td>
                                        {this.props.code} {this.props.data.original_week ? this.props.data.original_week : '-'}
                                        </td>
                                        <td>
                                        {this.props.code} {this.props.data.original_month ? this.props.data.original_month : '-'}
                                        </td>
                                        <td>
                                        <span id="update_minimum_stay">  
                                         {this.props.data.minimum_stay ? this.props.data.minimum_stay + 'Night' : '-'} 
                                        </span>
                                        </td>
                                        <td><a  href='#' title="Edit" className="table_edit"><i className="fa fa-pencil" /></a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
