...
export default class Author extends React.PureComponent{
    ...
    componentDidMount(){
        ...
        Axios.get(`/ajax/blog/author/${this.props.match.params.authorid}`)
        .then(response =>{
            this.setState({
    ...
    componentWillReceiveProps(nextprops){
        Axios.get(`/ajax/blog/author/${nextprops.match.params.authorid}`)
        .then(response =>{
            this.setState({
                blog_list : response.data.posts,
                author : response.data.author
          ...
          <div className="itemList blog-item-pagination">
            {
                ...
                :
                <div>No blogs of {this.state.author.full_name}</div>
            }
           </div>
        </div>
      </div>
