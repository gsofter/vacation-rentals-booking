    ...
    render(){
        return(
            ...
            <div className="social-buttons">
              ...
              <a href='/login/google' className="btn icon-btn btn-block row-space-1 btn-large btn-google pad-23">
                <span>
            ...
            <div className="text-center social-links hide">
              Sign up with <a className="facebook-link-in-signup">Facebook</a> or <a>Google</a>
            </div>
            ...
            <div className="text-center">
              <a href="javascript:void(0);" className="create-using-email btn-block  row-space-2 btn btn-primary btn-block btn-large large icon-btn pad-23 signup_popup_head2 btn_new1" id="create_using_email_button" onClick={this.changeForm}>
                <span>
