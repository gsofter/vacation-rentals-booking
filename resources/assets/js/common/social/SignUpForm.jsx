...
class SignUpForm extends React.PureComponent{
  constructor(props){
    ...
    this.state = {
      ...
      linkedin_id : this.props.userData.linkedin_id,
      google_id : this.props.userData.google_id,
  ...
  onSignupSubmit(e){
    ...
    if(dt.getFullYear() - this.state.birthday_year > 18){
      if(this.state.agree_tac == true){
        axios.post('/ajax/signupSocial', this.state)
            .then(response => {
      ...
      toast.error("You cannot use our site because your age is less than 18.", {
        position: toast.POSITION.TOP_RIGHT
      });
    }
    ...
    render(){
        return(<div className="panel  bor-none row">
        <div className='col-md-2'></div>
        <div className="  panel-body   bor-none    col-md-6 mx-auto">
            ...
            <div className="">
                ...
                <div className="col-md-6 col-12">
                  <div className="control-group row-space-2 field_ico" id="inputFirst">
                    <div className="pos_rel">
                      ...
                      <input required className="decorative-input name-icon input_new tooltipstered" placeholder="First name" name="first_name" type="text" value={this.state.first_name} onChange={this.handleChange} />
                    </div>
                  </div>
                </div>
                <div className="col-md-6 col-12">
                  <div className="control-group row-space-2 field_ico" id="inputLast">
                    <div className="pos_rel">
                      <i className="icon-users" />
                      <input required className="decorative-input inspectletIgnore name-icon input_new tooltipstered" placeholder="Last name" name="last_name" value={this.state.last_name} type="text" onChange={this.handleChange} />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="col-md-6 col-12">
                  <div className="control-group row-space-2 field_ico" id="inputEmail">
                    <div className="pos_rel">
                      ...
                      <input required readOnly className="decorative-input inspectletIgnore name-mail name-icon input_new tooltipstered" placeholder="Email address"  name="email" type="email" onChange={this.handleChange} value={this.state.email} />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div id="tos_outside" className="row-space-top-2 chk-box tos-container">
                <div className="dis_tb control-group tooltipstered">
                  ...
                  <div className="dis_cell">
                    <small>
                      By signing up, I agree to Vacation.Rentals's <a href="#" data-popup="true">Terms of Service</a>, <a href="https://www.vacation.rentals/privacy_policy" data-popup="true">Privacy Policy</a>.
                    </small>
                  </div>
                </div>
              </div>
